...
def show_ctr(ax, data_orig, hdr_ctr, hdr_img, rms, num = 6, hpbw = 2., color = 'tomato', linewidths = 2):
    ...
    #     levels.append(level)
    # print(levels)
    levels = [0.00015, 0.00030, 0.00040, 0.0006, 0.0012000000000000001, 0.0024000000000000002, 0.0048000000000000004, 0.009600000000000001, 0.019200000000000002, 0.038400000000000004, 0.07680000000000001, 0.15360000000000001, 0.30720000000000003, 0.6144000000000001, 1.2288000000000001]
...
im = ax.imshow(data,  cmap = 'jet', norm=colors.LogNorm(gamma = 0.5, vmin=vmin, vmax=vmax), origin='lower')
set_ax(ax)
print(vmin, vmax)
# PSR 
